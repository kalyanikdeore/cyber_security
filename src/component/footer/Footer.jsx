...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#805b3a] text-white">
      ...
      {/* Bottom bar - UPDATED FOR MOBILE LEFT ALIGNMENT */}
      <div className="bg-[#6d4d32] py-4">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
            {/* Left-aligned on mobile, remains left on desktop */}
            <div className="w-full md:w-auto">
              <p className="text-[#faf6f2] text-sm text-left">
                © {currentYear} Navanvesha Foundation. All rights reserved.
              </p>
            </div>

            {/* Links - stack vertically on mobile, horizontal on desktop */}
            <div className="flex flex-col md:flex-row items-start md:items-center space-y-2 md:space-y-0 md:space-x-6 mt-2 md:mt-0">
              <Link
                to="/privacy-policy"
                className="text-[#faf6f2] hover:text-white text-sm transition duration-300 text-left md:text-center"
              >
                Privacy Policy
              </Link>
              <Link
