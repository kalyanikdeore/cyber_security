...
export default function TechnologyDigitalPrograms({ onCTAClick }) {
  const initiatives = [
    ...
    },
    {
      ...
      images: [career_guidance2, career_guidance909, career_guidance99],
      imagePosition: "left",
    ...
    },
    {
      ...
      images: [edumaterial, edumaterialsupport, educational_material],
      imagePosition: "left",
    ...
    },
    {
      ...
      images: [stmeclub, stem_clubs, stmeclubs],
      imagePosition: "left",
      layoutType: "pyramid",
    ...
    },
    {
      ...
      images: [ai_coding_computational_training, aicodding, ai],
      imagePosition: "left",
      layoutType: "pyramid",
        ...
        return (
          <div className="grid grid-cols-1 gap-3 sm:gap-4">
            <motion.div
              ...
              viewport={{ once: true }}
              className="relative rounded-xl overflow-hidden group h-48 sm:h-56 md:h-64"
            >
              <img
                src={images[0]}
            ...
            {images.map((img, index) => (
              <motion.div
                ...
                className={`absolute rounded-xl overflow-hidden group
                  ${
                    index === 0 &&
                    "top-0 left-0 w-2/3 h-48 sm:h-56 md:h-64 lg:h-72"
                  }
                  ${
                    index === 1 &&
                    "top-8 sm:top-12 md:top-16 left-12 sm:left-16 md:left-24 w-2/3 h-48 sm:h-56 md:h-64 lg:h-72"
                  }
                  ${
                    index === 2 &&
                    "top-16 sm:top-24 md:top-32 left-24 sm:left-28 md:left-48 w-2/3 h-48 sm:h-56 md:h-64 lg:h-72"
                  }
                `}
              >
                <img
        ...
        return (
          <div className="grid grid-cols-3 gap-3 sm:gap-4">
            <motion.div
              ...
              transition={{ duration: 0.5 }}
              viewport={{ once: true }}
              className="col-span-2 relative rounded-xl overflow-hidden bg-center group h-60 sm:h-72 md:h-80 lg:h-96"
            >
              <img
                src={images[0]}
                alt={`${initiative.title} 1`}
            ...
            <div className="flex flex-col gap-3 sm:gap-4">
              {images.slice(1).map((img, index) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="relative rounded-xl overflow-hidden group h-28 sm:h-32 md:h-36 lg:h-44"
                >
                  <img
                    src={img}
                    alt={`${initiative.title} ${index + 2}`}
      ...
      case "diagonal":
        return (
          <div className="w-full py-4 sm:py-6 md:py-8">
            <div className="flex justify-center gap-4 sm:gap-6 md:gap-8 mb-4 sm:mb-6 md:mb-8 relative h-48 sm:h-60 md:h-72 lg:h-80">
              {images.slice(0, 2).map((img, index) => (
                <motion.div
                  ...
                  transition={{ duration: 0.6, delay: index * 0.2 }}
                  viewport={{ once: true }}
                  className={`w-1/2 h-48 sm:h-60 md:h-72 lg:h-80 rounded-xl overflow-hidden border-2 sm:border-3 md:border-4 border-white
                    group hover:-translate-y-2 transition-transform duration-500 absolute
                    ${
                      index === 0
                        ? "rotate-[-4deg] -translate-x-16 sm:-translate-x-24 md:-translate-x-32 z-20"
                        : "rotate-[4deg] translate-x-16 sm:translate-x-24 md:translate-x-32 z-10"
                    }`}
                >
                  <img
                    src={img}
            ...
            >
              <div className="w-4/5 sm:w-3/4 md:w-2/3 h-48 sm:h-60 md:h-72 lg:h-80 rounded-xl overflow-hidden border-2 sm:border-3 md:border-4 border-white group hover:-translate-y-2 transition-transform duration-500 rotate-[-2deg]">
                <img
                  src={images[2]}
                  alt="single-image"
      ...
      case "pyramid":
        return (
          <div className="w-full py-2 sm:py-3 md:py-4">
            ...
            >
              <div className="w-full h-40 sm:h-48 md:h-56 lg:h-64 rounded-xl overflow-hidden group border-2 sm:border-3 md:border-4 border-white">
                <img
                  src={images[0]}
                  alt={`${initiative.title} 1`}
                  className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-110"
            ...
            <div className="grid grid-cols-2 gap-3 sm:gap-4 md:gap-6 justify-items-center">
              {images.slice(1).map((img, index) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="w-full h-32 sm:h-40 md:h-48 lg:h-56 rounded-xl overflow-hidden group border-2 sm:border-3 md:border-4 border-white"
                >
                  <img
                    src={img}
                    alt={`${initiative.title} ${index + 2}`}
