      ...
      case "vertical-stack":
        return (
          <div className="relative w-full min-h-[400px]">
            ...
            ${index === 0 && "top-0 left-0 w-2/3 h-72"}
            ${index === 1 && "top-16 left-24 w-2/3 h-72"}
            ${index === 2 && "top-32 left-48 w-2/3 h-72"}
          `}
              >
                <img
                  src={img}
        ...
        return (
          <div className="grid grid-cols-3 gap-4">
            <motion.div
              ...
              transition={{ duration: 0.5 }}
              viewport={{ once: true }}
              className="col-span-2 relative rounded-xl overflow-hidden bg-center group h-96"
            >
              <img
                src={images[0]}
                alt={`${initiative.title} 1`}
            ...
            <div className="flex flex-col gap-4">
              {images.slice(1).map((img, index) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="relative rounded-xl overflow-hidden group h-44"
                >
                  <img
                    src={img}
                    alt={`${initiative.title} ${index + 2}`}
