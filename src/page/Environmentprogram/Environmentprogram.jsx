...
export default function TechnologyDigitalPrograms({ onCTAClick }) {
  const initiatives = [
    ...
    },
    {
      ...
      images: [climate_education_in_schools, cliement1, climate],
      imagePosition: "left",
...
function getProgramHighlights(initiativeId) {
  const highlights = {
    ...
    6: [
      "Transforming traditional classrooms into interactive digital learning environments with smart displays",
    ],
  };
