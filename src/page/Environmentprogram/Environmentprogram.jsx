  ...
  const initiatives = [
    {
      ...
      images: [treeplan99, treeplan, treeplan3],
      imagePosition: "left",
    ...
    },
    {
      ...
      images: [climateeducation, cliement1, climate],
      imagePosition: "left",
            ...
            {images.map((img, index) => (
              ...
              >
                <img
                  src={img}
                  alt={`${initiative.title} ${index + 1}`}
                  className="h-56 w-full object-fit transition-transform duration-500 group-hover:scale-105"
                />
                {index === 0 && (
...
function getProgramHighlights(initiativeId) {
  const highlights = {
    1: ["Focus on sapling maintenance and survival tracking post-planting."],
    2: ["Shifting behavior toward a circular economy model."],
    3: [
      "Interactive sessions, field trips, and school-based environmental clubs.",
    ],
    4: [
      "Spreading awareness on smart energy usage, renewable energy adoption & reducing carbon footprint",
    ],
    5: [
      "Tree plantation drives, clean-up activities & public space beautification",
    ],
  };
