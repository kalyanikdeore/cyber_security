      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          {goals.map((goal) => (
            ...
            >
              <motion.div
                className={`relative h-full ${goal.color} rounded-2xl sm:rounded-3xl border-2 ${goal.borderColor} p-5 sm:p-6 md:p-8 transition-all duration-500 transform hover:scale-[1.02] hover:shadow-lg sm:hover:shadow-2xl hover:shadow-[#926b49]/20`}
              ...
              >
                ...
                >
                  ...
                  >
                    <span
                      className={`text-lg sm:text-xl md:text-2xl font-black ${goal.textColor}`}
                    >
                      {goal.number}
                    </span>
                  </div>
                ...
                <motion.h3
                  className={`text-xl sm:text-2xl font-bold mb-3 sm:mb-4 leading-tight ${goal.textColor}`}
                  ...
                  {goal.stats.map((stat, index) => (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div
                          className={`font-bold text-sm sm:text-base truncate ${goal.textColor}`}
                        >
                          {stat.value}
                        </div>
                      </div>
